    ...
    local foldername = "RIPPER V2 Hub"
    local filename = "BloxFruit 17.3"..game.Players.LocalPlayer.Name.." Config.json"
    ...
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/okuhubxx/okuhub-By/main/README.md"))()
    local Wait = library.subs.Wait
    
    local PepsisWorld = library:CreateWindow({
        Name = "xSoku Hub",
        Themeable = {
        Info = "Discord Server: xSoku Hub"
        }
    })
